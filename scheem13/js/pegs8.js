scheem = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c3 = [],
        peg$c4 = function(es) { return es;},
        peg$c5 = function(f, el) { return [ f ].concat(el); },
        peg$c6 = /^[0-9a-zA-Z_?!+\-=@#$%\^&*\/.]/,
        peg$c7 = { type: "class", value: "[0-9a-zA-Z_?!+\\-=@#$%\\^&*\\/.]", description: "[0-9a-zA-Z_?!+\\-=@#$%\\^&*\\/.]" },
        peg$c8 = /^[0-9]/,
        peg$c9 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c10 = function(e) { return parseInt(e, 10); },
